  ...
  <div class="modal-dialog modal-lg">    
    ...
    <div class="modal-content">
      <div class="modal-header" style="padding:25px 50px; ">
        <?php if($row['201date'] != null){ echo '<button type="button" class="close" data-dismiss="modal">&times;</button>';}?>
      ...
      <div class="modal-body" style="padding:20px 50px;">
        ...
        <div class = "col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
            ...
            <a href = "takephoto.php" class="btn btn-primary"> Takte Photo </a>
         </div>
          <div class="col-md-7">
            <label for="esname"> Surname <font color = "red">*</font></label>
            <input type="text" autofocus value = "<?php echo $row['lname']; ?>"name = "esname" id = "esname" style = "font-weight:normal;text-transform:capitalize;" class="form-control" required autocomplete="off"placeholder="Enter surname">
          </div>
          <div class="col-md-7">
            <label for="efname"> First Name <font color = "red">*</font></label>
            <input type="text" name = "efname" value = "<?php echo $row['fname']; ?>" id = "efname" style = "font-weight:normal;text-transform:capitalize;" class="form-control" required autocomplete="off"placeholder="Enter first name">
          </div>
          <div class="col-md-7">
            <label for="emname"> Middle Name <font color = "red">*</font></label>
            <input type="text" name = "emname" value = "<?php echo $row['mname']; ?>" id = "emname" style = "font-weight:normal;text-transform:capitalize;" class="form-control" required autocomplete="off"placeholder="Enter middle name">
          </div>
        </div>
        <div class="row">
         <div class="col-md-8">
          ...
          <div class="col-md-4">
            ...
            <input type="text" value = "<?php echo $row['econt']; ?>"name = "econt" pattern = '[0-9]+' required style = "font-weight:normal;text-transform:capitalize;" class="form-control" placeholder="Enter contact #">
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
         ...
         <div class="col-md-4">
            ...
            <input type="text" value = "<?php echo $row['etel']; ?>"name = "etel" pattern = '[0-9]+' style = "font-weight:normal;text-transform:capitalize;" required class="form-control" placeholder="Enter tel. #">
          </div>
        </div>
       <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <input type="date" value = "<?php echo $row['edatehired']; ?>" name = "edatehired" style = "font-weight:normal;" class="form-control" required autocomplete="off"placeholder="Enter middle name">
        </div>
        <div class="col-md-4">
      ...
      <div id = "marriedform" style="<?php if($row['ecstatus'] == 'Married'){ echo 'display: inline';} else{ echo 'display: none;"';}?>">
          ...
          <div class="row">
            <div class="col-md-6">            
              ...
              <input type="text" value = "<?php echo $row['childname2']; ?>"id = "childname2" name = "childname2" style = "font-weight:normal;text-transform:capitalize;" class="form-control" autocomplete="off"placeholder="Enter name of child">
              <input type="text" value = "<?php echo $row['childname3']; ?>"id = "childname3" name = "childname3" style = "font-weight:normal;text-transform:capitalize;" class="form-control" autocomplete="off"placeholder="Enter name of child">
              <input type="text" value = "<?php echo $row['childname4']; ?>"id = "childname4" name = "childname4" style = "font-weight:normal;text-transform:capitalize;" class="form-control" autocomplete="off"placeholder="Enter name of child">
              <input type="text" value = "<?php echo $row['childname5']; ?>"id = "childname5" name = "childname5" style = "font-weight:normal;text-transform:capitalize;" class="form-control" autocomplete="off"placeholder="Enter name of child">
            </div>
            <div class="col-md-6">           
              <input <?php if($row['childbday1'] != null){echo 'value = "'.date('F j, Y', strtotime($row['childbday1'])).'"'; echo 'type="text"';}else{echo 'type="date"';} ?>id = "childbday" name = "childbday" style = "font-weight:normal;" class="form-control" autocomplete="off"placeholder="Enter birthdate of child">
              <input <?php if($row['childbday2'] != null){echo 'value = "'.date('F j, Y', strtotime($row['childbday2'])).'"'; echo 'type="text"';}else{echo 'type="date"';} ?>id = "childbday2" name = "childbday2" style = "font-weight:normal;" class="form-control" autocomplete="off"placeholder="Enter birthdate of child">
              <input <?php if($row['childbday3'] != null){echo 'value = "'.date('F j, Y', strtotime($row['childbday3'])).'"'; echo 'type="text"';}else{echo 'type="date"';} ?>id = "childbday3" name = "childbday3" style = "font-weight:normal;" class="form-control" autocomplete="off"placeholder="Enter birthdate of child">
              <input <?php if($row['childbday4'] != null){echo 'value = "'.date('F j, Y', strtotime($row['childbday4'])).'"'; echo 'type="text"';}else{echo 'type="date"';} ?>id = "childbday4" name = "childbday4" style = "font-weight:normal;" class="form-control" autocomplete="off"placeholder="Enter birthdate of child">
              <input <?php if($row['childbday5'] != null){echo 'value = "'.date('F j, Y', strtotime($row['childbday5'])).'"'; echo 'type="text"';}else{echo 'type="date"';} ?>id = "childbday5" name = "childbday5" style = "font-weight:normal;" class="form-control" autocomplete="off"placeholder="Enter birthdate of child">
              </div>
            </div>
        </div>
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" value = "<?php echo $row['ebday']; ?>" name = "ebday" id = "esname" style = "font-weight:normal;" class="form-control" required autocomplete="off"placeholder="Enter Blood Type">
          </div>
          <div class="col-md-4">
...
<script type="text/javascript">
  $('#cstatus').change(function() {
    ...
    if(selected == 'Married'){
        $('#marriedform').show();
        $("#childname").attr('required',true);
        $("#childbday").attr('required',true);
        $("#spousename").attr('required',true);
        $("#numofchildren").attr('required',true);
      }else{
        $('#marriedform').hide();
        $("#childname").attr('required',false);
        $("#childname").attr('required',false);
...
if(isset($_POST['submitprof'])){
  ...
  $sql ="UPDATE login set 
    ...
    esss = '$esss', ephilhealth = '$ephilhealth', etin = '$etin', enameofschool = '$enameofschool', eschooladd = '$eschooladd', egrad = '$egrad',

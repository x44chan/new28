...
<?php 
	...
	<div id = "report"><h2 align = "center">Employee List</h2>';
		<table id = "myTable" align = "center" class = "table table-hover" style="font-size: 16px;">
		<thead>
				<tr>
					<th>Account ID</th>
					<th>Name</th>
...
<?php 
		...
		if($result->num_rows > 0){
			while($row = $result->fetch_assoc()){
				...
				echo '<td>' . strtolower($row['department']) . '</td>';
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body" style="padding:20px 50px; font-size: 17px; overflow-y: auto;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <i><p style = "margin-left: 10px;" id = "usrname"><?php echo date('F j, Y', strtotime($row['eduration'], strtotime($row['edatehired'])));?></p></i>
          </div>
        </div>
       <div class="row">
        <div class="col-md-4">
      ...
      <div id = "marriedform" style="<?php if($row['ecstatus'] == 'Married'){ echo 'display: inline';} else{ echo 'display: none;"';}?>">
          ...
          <div class="row">
            ...
            <div class="col-md-4">           
            	<?php if($row['childbday1'] != null){ echo '<i><p style = "margin-left: 10px;" id = "usrname">'. $row['childbday1'] .'</p></i>';}?>
        		<?php if($row['childbday2'] != null){ echo '<i><p style = "margin-left: 10px;" id = "usrname">'. $row['childbday2'] .'</p></i>';}?>
        		<?php if($row['childbday3'] != null){ echo '<i><p style = "margin-left: 10px;" id = "usrname">'. $row['childbday3'] .'</p></i>';}?>
        		<?php if($row['childbday4'] != null){ echo '<i><p style = "margin-left: 10px;" id = "usrname">'. $row['childbday4'] .'</p></i>';}?>
        		<?php if($row['childbday5'] != null){ echo '<i><p style = "margin-left: 10px;" id = "usrname">'. $row['childbday5'] .'</p></i>';}?>
            </div>
            </div>
            <div style="border-bottom: 1px solid #eee;"></div>
        </div>
